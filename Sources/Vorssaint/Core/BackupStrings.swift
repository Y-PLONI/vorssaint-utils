...
extension BackupFeatureStrings {
    ...
    static let he = BackupFeatureStrings(
        title: "גיבוי",
        description: "קח את ההגדרות שלך ל-Mac אחר: ייצא את כל ההעדפות לקובץ וייבא אותו שם. הקובץ כולל את הטקסט מהערות המחברת שלך. היסטוריית לוח הגזירים, פריטי המדף והרשאות המערכת לעולם לא עוזבים את ה-Mac הזה.",
